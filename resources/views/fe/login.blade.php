    ...
    <div class="container">
      ...
      <section class="h-100 py-5">
        ...
        @endif
            ...
            <div class="col-md-8">
              <h2>Login User</h2>
              <p>Don't have an account? click to <a href="{{route('register')}}">Register</a></p>
              <hr>
              <form name="form" method='POST'>
                ...
                <div class="mb-3">
                  <p>Didn't rember your password? click to <a href="../pages/forgotPassword.html">Recover</a></p>
                </div>
              </form>
            </div>
          </div>
